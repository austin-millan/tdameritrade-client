...
func (o UserPrincipalPreferences) MarshalJSON() ([]byte, error) {
...
type NullableUserPrincipalPreferences struct {
	value *UserPrincipalPreferences
	isSet bool
}

func (v NullableUserPrincipalPreferences) Get() *UserPrincipalPreferences {
	return v.value
}

func (v *NullableUserPrincipalPreferences) Set(val *UserPrincipalPreferences) {
	v.value = val
	v.isSet = true
}

func (v NullableUserPrincipalPreferences) IsSet() bool {
	return v.isSet
}

func (v *NullableUserPrincipalPreferences) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserPrincipalPreferences(val *UserPrincipalPreferences) *NullableUserPrincipalPreferences {
	return &NullableUserPrincipalPreferences{value: val, isSet: true}
}

func (v NullableUserPrincipalPreferences) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserPrincipalPreferences) UnmarshalJSON(src []byte) error {
	v.isSet = true
